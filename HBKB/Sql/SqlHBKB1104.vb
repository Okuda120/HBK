...
Public Class SqlHBKB1104
    ...
    ''' <param name="dataHBKB1104">[IN]システム登録画面データクラス</param>
    ''' <returns>boolean エラーコード  true 正常終了  false	異常終了 </returns>
    ''' <remarks>サーバー日付取得用のSQLを作成し、アダプタにセットする
    ''' <para>作成情報：2012/07/17 r.hoshino
    ''' <p>改訂情報：</p>
    ''' </para></remarks>
    ...
    Public Function SetSelectSyuBetsueCmb(ByRef Adapter As NpgsqlDataAdapter, _
        ...
        Try
            ...
            Adapter.SelectCommand.Parameters("CIKbnCD").Value = DataHBKB1104.PropStrCIKbnCD
    ...
    Public Function SetSelectSyuBetsuNumStatus(ByRef Adapter As NpgsqlDataAdapter, _
        ...
        Try
            ...
            Adapter.SelectCommand.Parameters("StrSyubetsuNum").Value = DataHBKB1104.PropStrSyubetsuNum
    ...
    Public Function SetUpdateCISap(ByRef Cmd As NpgsqlCommand, _
        ...
        Try
            ...
            'バインド変数に値をセット
            With Cmd
                .Parameters("StrSyubetsuNum").Value = dataHBKB1104.PropStrSyubetsuNum                   '種別コード＋番号
                .Parameters("UpdateDT").Value = DataHBKB1104.PropDtmSysDate                             '最終更新日時
    ...
    Public Function strInsertRegReasonR(ByRef Cmd As NpgsqlCommand, _
        ...
        Try
            ...
            'バインド変数に値をセット
            With Cmd
                .Parameters("RegReason").Value = dataHBKB1104.PropStrRegReason                                  '登録理由
                .Parameters("StrSyubetsuNum").Value = DataHBKB1104.PropStrSyubetsuNum                           '種別コード＋番号
                .Parameters("RegDT").Value = DataHBKB1104.PropDtmSysDate                                        '登録日時
    ...
    Public Function SetInsertCauseLinkRSql(ByRef Cmd As NpgsqlCommand, _
        ...
        Try
            ...
            'バインド変数に値をセット
            With Cmd
                .Parameters("MngNmb").Value = DataHBKB1104.PropIntMngNmb                                    '管理番号
                .Parameters("ProcessKbn").Value = DataHBKB1104.PropStrProcessKbn                            'プロセス区分
                .Parameters("StrSyubetsuNum").Value = DataHBKB1104.PropStrSyubetsuNum                       '種別コード＋番号
                .Parameters("RegDT").Value = DataHBKB1104.PropDtmSysDate                                    '登録日時
                .Parameters("RegGrpCD").Value = PropWorkGroupCD                                             '登録者グループCD
                .Parameters("RegID").Value = PropUserId                                                     '登録者ID
